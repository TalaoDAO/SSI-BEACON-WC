    ...
    a.modal_connect_headline = "string" == typeof a.modal_connect_headline ? a.modal_connect_headline : "Choose your wallet type"; a.btn_disconnect_label = "string" == typeof a.btn_disconnect_label ? a.btn_disconnect_label : "Disconnect"; a.parent_container = "object" == typeof a.parent_container ? a.parent_container : document.getElementsByTagName("body")[0]; a.web3network = "number" == typeof a.web3network ? a.web3network : 1; this.handlers = {
        ...
        if (b._modaldiv) b._trigger_callback("btnconnect_clicked", "hide"), b._modaldiv.parentElement.removeChild(b._modaldiv), b._modaldiv =
            !1, b._trigger_callback("modal_closed", !0); else {
                console.log(KV.get_available_providers())
            for (var d = KV.get_available_providers(), c = "", e = 0; e < d.length; e++)switch (d[e]) {}d =
                function (l) {
                    
                    for (var g = document.getElementsByClassName("kvwalletbtn"), h = 0; h < g.length; h++)g[h].classList.remove("selected"), /*g[h].disabled = !0;*/ l.target.classList.add("selected");console.log(l.target); b._trigger_callback("wallet_connecting", l.target.id); switch (l.target.id) { case "kvwalletmodal_binance_btn": KV.set_provider("binancewallet"); break;case "kvwalletmodal_coinbase_btn": console.log("coinbaseWallet");KV.set_provider("coinbasewallet"); break; case "requestPermission": console.log("walletconnectttt");KV.set_provider("walletconnect");  break; case "kvwalletmodal_walletconnect_btn2": KV.set_provider("walletconnect"); break;case "kvwalletmodal_walletconnect_btn4": KV.set_provider("walletconnect"); break;case "kvwalletmodal_walletconnect_btn5": KV.set_provider("walletconnect"); break; case "kvwalletmodal_walletconnect_btn3": KV.set_provider("walletconnect"); break; case "kvwalletmodal_walletconnect_btn6": KV.set_provider("walletconnect")}
